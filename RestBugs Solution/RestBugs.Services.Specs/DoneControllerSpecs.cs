...
{
    public class when_getting_all_done_bugs
    {
        Establish context = () =>
        {
            ...
            controller = new DoneController(mockRepo.Object);
        };

        Because of = () => {
            controller.Get().TryGetContentValue<IEnumerable<BugDTO>>(out resolvedBugs);
        };
        ...
        static DoneController controller;
    }
}